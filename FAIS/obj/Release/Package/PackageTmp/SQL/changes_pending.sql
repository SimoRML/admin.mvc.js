...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.BO_ROLE
	DROP CONSTRAINT DF_BO_ROLE__READ
GO
ALTER TABLE dbo.BO_ROLE
	DROP CONSTRAINT DF_BO_ROLE__WRITE
GO
ALTER TABLE dbo.BO_ROLE
	DROP CONSTRAINT DF__BO_ROLE__CREATED__1293BD5E
GO
ALTER TABLE dbo.BO_ROLE
	DROP CONSTRAINT DF__BO_ROLE__UPDATED__1387E197
GO
CREATE TABLE dbo.Tmp_BO_ROLE
	(
	BO_ROLE_ID bigint NOT NULL IDENTITY (1, 1),
...
GO
ALTER TABLE dbo.Tmp_BO_ROLE SET (LOCK_ESCALATION = TABLE)
GO
ALTER TABLE dbo.Tmp_BO_ROLE ADD CONSTRAINT
	DF_BO_ROLE__READ DEFAULT ((0)) FOR CAN_READ
GO
ALTER TABLE dbo.Tmp_BO_ROLE ADD CONSTRAINT
	DF_BO_ROLE__WRITE DEFAULT ((0)) FOR CAN_WRITE
GO
ALTER TABLE dbo.Tmp_BO_ROLE ADD CONSTRAINT
	DF__BO_ROLE__CREATED__1293BD5E DEFAULT (getdate()) FOR CREATED_DATE
GO
ALTER TABLE dbo.Tmp_BO_ROLE ADD CONSTRAINT
	DF__BO_ROLE__UPDATED__1387E197 DEFAULT (getdate()) FOR UPDATED_DATE
GO
SET IDENTITY_INSERT dbo.Tmp_BO_ROLE ON
GO
IF EXISTS(SELECT * FROM dbo.BO_ROLE)
	 EXEC('INSERT INTO dbo.Tmp_BO_ROLE (BO_ROLE_ID, META_BO_ID, ROLE_ID, CAN_READ, CAN_WRITE, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, STATUS)
		SELECT BO_ROLE_ID, META_BO_ID, ROLE_ID, CAN_READ, CAN_WRITE, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, STATUS FROM dbo.BO_ROLE WITH (HOLDLOCK TABLOCKX)')
GO
SET IDENTITY_INSERT dbo.Tmp_BO_ROLE OFF
GO
DROP TABLE dbo.BO_ROLE
GO
EXECUTE sp_rename N'dbo.Tmp_BO_ROLE', N'BO_ROLE', 'OBJECT' 
GO
ALTER TABLE dbo.BO_ROLE ADD CONSTRAINT
	PK_BO_ROLE PRIMARY KEY CLUSTERED 
	(
	BO_ROLE_ID
