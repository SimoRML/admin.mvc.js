...
CREATE TABLE [dbo].[BON_DA] (
[BO_ID] bigint NOT NULL ,
[REF] varchar(50) NULL ,
[VALIDATED_DATE] datetime NULL ,
[VALIDATED_BY] varchar(100) NULL ,
[DEMANDEUR] varchar(100) NULL ,
[DATE_SOUHAITE] datetime NULL ,
[DURATION] int NULL ,
[OBSERVATION] varchar(1000) NULL ,
[FOURNISSEUR_ID] bigint NULL ,
[ORDER_REF] varchar(100) NULL ,
[PAYEMENT_MODE] varchar(100) NULL ,
[PAYEMENT_CONDITION] varchar(100) NULL ,
[REF_BON_LIVRAISON] varchar(50) NULL 
)
GO

ALTER TABLE [dbo].[BON_DA] ADD PRIMARY KEY ([BO_ID])
GO

ALTER TABLE [dbo].[BON_DA] ADD FOREIGN KEY ([BO_ID]) REFERENCES [dbo].[BO] ([BO_ID]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
